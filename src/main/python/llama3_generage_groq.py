...
SUB_KNOWLEDGE_BASE = {
    "Splat Bomb": "Lethal bomb. Throwable. Great for lethal traps, flushing out enemies, and stalling pursuers.",
    "Suction Bomb": "Lethal bomb. Throwable. Longer fuse time than Splat Bomb. Excellent for lethal traps, area denial and objective control.",
...
SPECIAL_KNOWLEDGE_BASE = {
    "Big Bubbler": "Anchoring Special. Protects players inside from outside fire. Great for holding ground or the objective.",
    "Tacticooler": "Team buffs. Gives teammates massive improvements to swim speed, run speed, and respawn time.",
    "Kraken Royale": "Melee special. Transforms the user into an invincible giant squid that can charge forward for one-hit splats or stall the objective.",
    "Wave Breaker": "Area control. A deployable device that sends out waves that deal chip damage and track the position of enemies that touch them.",
...
def generate_team_explanation(recommended_team, bravo_team, advantages, deficits):
    ...
    system_prompt = """ROLE:
You are an expert competitive Splatoon 3 coach and data analyst.

INSTRUCTIONS:
- Write a snappy, 3-4 sentence explanation of how Team Alpha's weapons work together.
- Translate the raw data, weapon strengths, and kit synergies into a concise competitive strategy.
- Highlight at least one weakness of a Team Bravo weapon that Team Alpha can exploit.
- Call the weapons by their nicknames in the justification paragraph.
